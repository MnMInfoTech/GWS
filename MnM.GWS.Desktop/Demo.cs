...
namespace MnM.GWS.Desktop
{
    public partial class Demo : Form, IShowable, IHideable
    {
        ...
        private void OnLoad(object sender, System.EventArgs e)
        {
            ...
            chkLstLinePattern.Items.Add(Command.Dot);
            chkLstLinePattern.Items.Add(Command.Dash);
            chkLstLinePattern.Items.Add(Command.DashDotDash);
        ...
        private void Draw(object sender, System.EventArgs e)
        {
            ...
            Window.Clear(Settings.Session, Command.SkipUpdate);
        ...
        private void SaveGraphics(object sender, System.EventArgs e)
        {
            ...
            {
                Window.SaveAs(saveFileDialog1.FileName, ImageFormat.BMP);
            }
        }
        private void CurveOptionCheck(object sender, ItemCheckEventArgs e)
        {
            if (e.Index == -1)
                return;
        ...
        unsafe void SetGwsMethod()
        {
            ...
            if (textureBrush == null)
            {
                ...
                if (lstColors.Items.Count > 0)
                {
                    ...
                    fStyle = new BrushStyle(grad, all.Select(x => ((System.Drawing.Color)x).ToArgb()).ToArray());
                }
                else
                {
            ...
            if (chkInvertBrush.Checked)
                Settings.Command |= Command.InvertBrushRotation;
            else
                Settings.Command &= ~Command.InvertBrushRotation;
#endif
                ...
                case "Ellipse":
                    ...
                    else if (drawPoints?.Length >= 8)
                    {
                        GwsMethod = () => Canvas.DrawEllipse(
                            ...
                            new VectorF(drawPoints[2], drawPoints[3]),
                            new VectorF(drawPoints[4], drawPoints[5]),
                            new VectorF(drawPoints[6], drawPoints[7]), Settings);
                    }
                    else if (drawPoints?.Length >= 6)
                    {
                        GwsMethod = () => Canvas.DrawEllipse(
                            new VectorF(drawPoints[0], drawPoints[1]),
                            new VectorF(drawPoints[2], drawPoints[3]),
                            new VectorF(drawPoints[4], drawPoints[5]), Settings);
                    }
            ...
            if (txtPts.Text.Length > 1)
            {
                ...
                switch (shape)
                {
                    ...
                    case "Trapezium":
                        if (drawPoints.Length < 4)
                            goto exit;
                        rc = Vectors.ToPointsF(drawPoints).ToArea();
                        x = rc.X;
                        y = rc.Y;
                        w = rc.Width;
                        h = rc.Height;
        ...
        Rotation SetAngle()
        {
            ...
            return new Rotation(value, x.Round(), y.Round(), hasCenter, (SkewType)cmbZRotateDirection.SelectedItem);
        }
        internal void SetMsMethod()
        {
            ...
            if (textureBrush == null)
            {
                ...
                var colors = all.Select(x => (System.Drawing.Color)x).ToArray();
            ...
            switch (cmbShape.Text)
            {
                ...
                case "Bezier":
                    ...
                    break;
                case "Glyphs":
                    MsMethod = () => MsDisplay.Screen.Canvas.DrawString(txtPts.Text, MsFont, MsBrush, new System.Drawing.PointF(10, 10));
    ...
    partial class Demo
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.chkOddEvenStroking = new System.Windows.Forms.CheckBox();
            ...
            this.chkImageOperation.Location = new System.Drawing.Point(124, 101);
            ...
            this.txtShapeCenter.Location = new System.Drawing.Point(85, 68);
            ...
            // chkOddEvenStroking
            // 
            this.chkOddEvenStroking.AutoSize = true;
            this.chkOddEvenStroking.Font = new System.Drawing.Font("Calibri", 9.75F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
            this.chkOddEvenStroking.ForeColor = System.Drawing.SystemColors.Control;
            this.chkOddEvenStroking.Location = new System.Drawing.Point(9, 136);
            this.chkOddEvenStroking.Name = "chkOddEvenStroking";
            this.chkOddEvenStroking.Size = new System.Drawing.Size(104, 19);
            this.chkOddEvenStroking.TabIndex = 133;
            this.chkOddEvenStroking.Text = "Odd-Even rule";
            this.chkOddEvenStroking.UseVisualStyleBackColor = true;
            // 
            // chkCenter
            // 
