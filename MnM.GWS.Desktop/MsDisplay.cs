...
namespace MnM.GWS.Desktop
{
    public partial class MsDisplay : Form
    {
        ...
        internal Graphics Canvas { get; private set; }
        ...
        void Draw(object sender, System.Windows.Forms.PaintEventArgs e)
        {
            ...
            if (rotate)
            {
                ...
                PointF p;
                matrix.RotateAt(rotate.Degree, new PointF(rotate.Cx, rotate.Cy));
        ...
        internal void Refresh(string shapeName, Rotation angle)
        {
            shape = shapeName;
            rotate = angle;
            Refresh();
