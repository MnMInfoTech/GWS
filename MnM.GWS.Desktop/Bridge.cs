...
namespace MnM.GWS.Desktop
{
	...
	public static class MSBridge
    {
		...
		public static Key ToGWSKey(this Keys key)
		{
			switch (key)
			{
				case Keys.KeyCode: return Key.KeyCode;

				case Keys.Modifiers: return Key.Modifiers;

				case Keys.None: return Key.None;

				case Keys.LButton: return Key.LButton;

				case Keys.RButton: return Key.RButton;

				case Keys.Cancel: return Key.Cancel;

				case Keys.MButton: return Key.MButton;

				case Keys.XButton1: return Key.XButton1;

				case Keys.XButton2: return Key.XButton2;

				case Keys.Back: return Key.Back;

				case Keys.Tab: return Key.Tab;

				case Keys.LineFeed: return Key.LineFeed;
				...
				case Keys.Capital: return Key.Capital;

				case Keys.KanaMode: return Key.KanaMode;

				case Keys.JunjaMode: return Key.JunjaMode;

				case Keys.FinalMode: return Key.FinalMode;

				case Keys.HanjaMode: return Key.HanjaMode;


				case Keys.Escape: return Key.Escape;

				case Keys.IMEConvert: return Key.IMEConvert;

				case Keys.IMENonconvert: return Key.IMENonconvert;

				case Keys.IMEAccept: return Key.IMEAccept;

				case Keys.IMEModeChange: return Key.IMEModeChange;

				case Keys.Space: return Key.Space;

				case Keys.Prior: return Key.Prior;

				case Keys.Next: return Key.Next;
				...
				case Keys.Snapshot: return Key.Snapshot;
				...
				case Keys.LWin: return Key.LWin;

				case Keys.RWin: return Key.RWin;

				case Keys.Apps: return Key.Apps;
				...
				case Keys.LShiftKey: return Key.LShiftKey;

				case Keys.RShiftKey: return Key.RShiftKey;

				case Keys.LControlKey: return Key.LControlKey;

				case Keys.RControlKey: return Key.RControlKey;

				case Keys.LMenu: return Key.LMenu;

				case Keys.RMenu: return Key.RMenu;
				...
				case Keys.MediaPreviousTrack: return Key.MediaPreviousTrack;
				...
				case Keys.SelectMedia: return Key.SelectMedia;
				...
				case Keys.EraseEof: return Key.EraseEof;
				...
				default:
					switch (key)
					{
						...
						case Keys.HangulMode: return Key.HangulMode;

						case Keys.KanjiMode: return Key.KanjiMode;

						case Keys.IMEAceept: return Key.IMEAceept;
