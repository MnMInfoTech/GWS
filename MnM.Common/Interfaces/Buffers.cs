...
namespace MnM.GWS
{
    ...
    /// </summary>
    public partial interface IImage : IGraphics, ICopyableScreen, IClearable, IWritableBlock, IResizable, IRenderableBlock, ICloneable, IDisposable2, IScalable
    { }
    #endregion

    #region ICANVAS
    public partial interface ICanvas : IImage, IContainer, IUpdatable, IRefreshable, IBackground, IReadable, IAnimationHost
    {
