...
namespace MnM.GWS
{
    ...
    public static partial class Matrixs
    {
        ...
        /// <returns>A scaling matrix.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static T CreateScale<T>(this VectorF scales) where T : IMatrix3x2, new()
        {
            T result = new T();
        ...
        /// <returns>A scaling matrix.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static T CreateScale<T>(this VectorF scales, VectorF centerPoint) where T : IMatrix3x2, new()
        {
            T result = new T();
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static T CreateRotation<T>(this Rotation angle, bool negative = false) where T : IMatrix3x2, new()
        {
            var degree = negative ? -angle.Degree : angle.Degree;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void Transform<T>(float x, float y, T matrix, out float newx, out float newy) where T : IMatrix3x2
        {
            //x*cos+y*-sin+x
            //x*sin+y*cos+y
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void Transform<T>(float x, float y, T matrix, out int newx, out int newy) where T : IMatrix3x2
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void Transform<T>(int x, int y, T matrix, out int newx, out int newy) where T : IMatrix3x2
        {
            newx = (x * matrix.M00 + y * matrix.M10 + matrix.M20).Round();
            newy = (x * matrix.M01 + y * matrix.M11 + matrix.M21).Round();
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void Transform<T>(int val, int axis, bool horizontal, T matrix, out float newx, out float newy) where T : IMatrix3x2
        {
            Vectors.ToXY(val, axis, horizontal, out int x, out int y);
            Transform(x, y, matrix, out newx, out newy);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void Transform<T>(int val, int axis, bool horizontal, T matrix, out int newx, out int newy) where T : IMatrix3x2
        {
            Vectors.ToXY(val, axis, horizontal, out int x, out int y);
            Transform(x, y, matrix, out newx, out newy);
        }
        ...
        /// <returns>The transformed vector.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static VectorF Transform<T>(this Vector position, T matrix) where T : IMatrix3x2
        {
            return new VectorF(
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Vector TransformNormal<T>(this Vector position, T matrix) where T : IMatrix3x2
        {
            return new VectorF(
