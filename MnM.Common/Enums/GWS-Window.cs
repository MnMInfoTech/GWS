...
namespace MnM.GWS
{
    ...
    public enum DrawCommand
    {
        ...
        /// <summary>
        /// Retains reference of main shape as being rendered while child shapes are being drawn.
        /// </summary>
        RetainShape = 0x40,
        ...
        /// </summary>
        AnimateRestore = Animate | 0x20000,
