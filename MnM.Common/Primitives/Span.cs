...
namespace MnM.GWS
{
    ...
    /// Struct Span
    /// </summary>
    public struct Span : ISpan, IComparable, IEquatable<Span>, IComparable<Span>, IReadOnlyList
    {
        #region VARIABLES
        int start, length;
        int? lineLength;
        ...
        {
            Enumerables.CorrectLength(ref start, ref length);
            this.start = start;
            this.length = length;
        ...
        {
            Enumerables.CorrectLength(ref start, ref length, listLength);
            this.start = start;
            this.length = length;
            this.lineLength = lineLength;
            this.lineBreaker = lineBreaker;
        ...
        {
            var tuple = Enumerables.CorrectLength(range, length);
        ...
        {
            var tuple = Enumerables.CorrectLength(range);
            this.start = tuple.Item1;
            this.length = tuple.Item2;
            this.lineLength = lineLength;
            this.lineBreaker = lineBreaker;
        ...
        public void CorrectLength(int listLength)
        {
            ...
            Enumerables.CorrectLength(this, listLength);
        }
        #endregion
