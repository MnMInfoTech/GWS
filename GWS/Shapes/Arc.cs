...
{
    #region IARC
    public interface IArc: IShape, IFigure
    {
        /// <summary>
    ...
    #region ARC
    public struct Arc: IArc, IExResizable
    {
        #region VARIABLES
        /// <summary>
        ...
        #region CONSTRUCTORS
        /// <summary>
        /// Creates a new arc specified by the bounding area, start and end angles.
        /// </summary>
        ...
        /// <param name="w">Width of a bounding area where the arc is to be drawn -> 
        /// circle/ellipse's minor X axis = Width/2</param>
        /// <param name="h">Height of a bounding area where the arc is to be drawn ->
        ...
        /// <param name="negativeMotion">Points of this arc are processed in anti clock wise motion.
        /// i.e. if start angle = 0 and end angle = 90, this option will draw an arc or pie from 90 to 360.</param>
        ...
        public Arc(float x, float y, float w, float h, float startAngle, float endAngle,
            bool negativeMotion = false, bool sweepAngle = true, bool pieAngle = true)
        {
            ...
            Points = Curves.GetArcPoints(StartAngle, EndAngle, false,
        ...
        this(parameters, x, y, w, h, startAngle, endAngle, negativeMotion, sweepAngle, pieAngle)
        { }
        ...
        /// <param name="h">Height of a bounding area where the arc is to be drawn ->
        /// circle/ellipse's minor Y axis = Height/2</param>
        public Arc(IEnumerable<IParameter> parameters, float x, float y, float w, float h,
        ...
        Arc(IArc arc, int w, int h)
        {
            ...
            Points = arc.GetPoints().Scale(new Scale(arc, w, h)).ToArray();
        }
        Arc(IArc arc)
        {
            Rx = arc.Rx;
            ...
            StartAngle = arc.StartAngle;
            EndAngle = arc.EndAngle;
            var subtract = new Point(arc.X, arc.Y);
            Points = arc.GetPoints().Select(pt => pt - subtract).ToArray();
        }
        #endregion
