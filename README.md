...
As for the Windowing support, we have provided one implementation of GWS with SDL. A binding project MnM.GWS.SDL provides all the requisite modules to make it work with SDL2.0. You can learn more about SDL at https://www.libsdl.org/. (SDL demo project is included here).
