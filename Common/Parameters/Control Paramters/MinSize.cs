...
namespace MnM.GWS
{
    public interface IMinSize : ISize, IProperty, IValid
    { }
    ...
    public struct MinSize : IMinSize
    {
        #region VARIABLES
        /// <summary>
        /// Value of Width.
        ...
        /// </summary>
        public readonly static MinSize Empty = new MinSize();
        #endregion
        ...
        /// <param name="width">Width value.</param>
        /// <param name="height">Height value.</param>
        public MinSize(float width, float height)
        {
            Width = (int)width;
            Height = (int)height;
            if (width - Width != 0)
