...
namespace MnM.GWS
{
    ...
    public static partial class Renderer
    {
        ...
        #region RENDER SHAPE
        /// <summary>
        /// Renders shape element on a given buffer with specified reading context.
        /// </summary>
        /// <param name="context">A pen context which to create a buffer pen from</param>
        public static void RenderShape(this IWritable Buffer, IShape shape, IReadContext readContext, out IPen Pen)
        {
            Pen = null;
            ...
            else
            {
                ...
                StrokePoints(Original, ShapeName, Settings.Stroke, Settings.StrokeMode, out Outer, out Inner);
            ...
            var Data = GetDrawParams(Settings.FillMode, Settings.FillCommand, Settings.Stroke, ShapeName, Original, Outer, Inner);
            ...
            if (Data[1] != null || Data[3] != null)
            {
                if (Settings.FillCommand.HasFlag(FillCommand.Outlininig))
                    ProcessWith(Data[1], Data[3], Settings, FillAction);
                else
                    Fill(Data[1].AppendItems(Data[3]), FillAction, oy, oBottom, Settings.FillCommand, Settings.LineCommand);
            }

            Process(Data[0], Action, Settings.LineCommand, skip0);
            Process(Data[2], Action, Settings.LineCommand, skip2);
