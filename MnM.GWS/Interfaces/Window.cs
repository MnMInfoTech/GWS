...
namespace MnM.GWS
{
    ...
    public interface IAnimationHost: IGraphics, IReadable
    {
    ...
    /// </summary>
    public partial interface IForm : INativeForm, IAnimationHost,
        IContainer, IRefreshable, IClearable, IDisposable2,
    ...
    /// </summary>
    public partial interface IElement : IRenderable, IPoint, ISize, IMinSizable, IBoundsHolder
    {
    }
    #endregion
